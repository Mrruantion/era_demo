...
class App extends Component {
    ...
    render() {
        ...
        return (
            <ThemeProvider>
                <div style={{ fontSize: '.24rem',minHeight:'100vh',background:'#f7f7f7' }}>
                    <div style={styles.head}>
                        <div style={styles.head_num}>{'￥' + toMoneyFormat(this.data.balance) + '元'}
                            <span><a style={{ fontSize: '16px', color: '#bdbdbd', marginLeft: 5 }} onTouchTap={this.toWithdraw} >{'明细>>'}</a></span>
                        </div>
                        <div style={{ textAlign: 'center', marginBottom: 20 }}>
                            <RaisedButton label="提现" backgroundColor="#27b1d0" labelColor="#fff" style={{ width: '60%' }} labelStyle={{ fontSize: '0.32rem' }} />
                        </div>
                        <div style={{ textAlign: 'center' }}>
                            <RaisedButton label="保证金" backgroundColor="#22ac38" labelColor="#fff" style={{ width: '60%' }} labelStyle={{ fontSize: '0.32rem' }} />
                        </div>
                    </div>
                    <div className="order-list">
                        <ul style={{ listStyle: 'none' }}>
                            <li><a >交易已完成订单<span className="num">768</span><i className="right-arrow"></i></a></li>
                            <li><a >待评价订单(0元)<span className="num">0</span><i className="right-arrow"></i></a></li>
                            <li><a >异常订单(0元)<span className="num">0</span><i className="right-arrow"></i></a></li>
                            <li><a >待扣款订单(0元)<span className="num">0</span><i className="right-arrow"></i></a></li>
                        </ul>
                    </div>
                </div>
            </ThemeProvider>
